...
public class AbnormalMdSliceTypeMap implements SliceTypeMap<String,String,String> {
    ...
    private List<String> typeNames = new ArrayList<String>() {{
        add(MarkdownSlice.CODE);
    }};
    private List<String> startTags = new ArrayList<String>() {{
        add("```");
    }};
    private List<String> endTags = new ArrayList<String>() {{
        add("```");
    }};

    private List<TypeEntity> types = new ArrayList<TypeEntity>() {{
        add(new TypeEntity(MarkdownSlice.CODE, "```", "```"));
    }};
