...
/**
 * @see http://www.cs.princeton.edu/courses/archive/fall03/cs126/assignments/barnes-hut.html
 */
public class Body {
    ...
    public void       addForce(Body b) {
        ...
        double F = (G * a.mass * b.mass) / (dist*dist + EPS*EPS);       //(G * a.mass * b.mass) / dist*dist 万有引力公式
        a.fx += F * dx / dist;
        a.fy += F * dy / dist;
    }
