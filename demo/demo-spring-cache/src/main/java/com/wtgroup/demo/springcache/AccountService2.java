...
public class AccountService2 {
    @Cacheable(value = "otherCache")// 使用了一个缓存名叫 accountCache / 默认使用入参第一个值作为缓存的key
    ...
    //清空缓存
    @CacheEvict(value = "otherCache",allEntries = true)// 清空 accountCache 缓存 / SEL(Spring Expression Language)
